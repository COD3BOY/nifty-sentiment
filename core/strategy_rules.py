...
STRATEGY_RULES: dict[str, dict] = {
    "Short Straddle": {
        ...
        "scoring_rules": [
            ...
            {"signal": "vol_regime", "condition": "sell_premium", "score_change": "+10", "description": "[CTX] Vol regime favors selling",
             "param_key": "vol_sell_premium_bonus", "default": 10},
            {"signal": "vol_regime", "condition": "stand_down", "score_change": "-10", "description": "[CTX] Vol regime stand-down",
             "param_key": "vol_stand_down_penalty", "default": -10},
            {"signal": "multi_day_trend", "condition": "neutral", "score_change": "+5", "description": "[CTX] Neutral trend suits neutral credit",
             "param_key": "trend_alignment_bonus", "default": 5},
            {"signal": "session_trend", "condition": "range_bound", "score_change": "+5", "description": "[CTX] Session range-bound",
             "param_key": "session_range_bound_bonus", "default": 5},
            {"signal": "session_ema", "condition": "bullish/bearish", "score_change": "-3", "description": "[CTX] Session EMA aligned hurts neutral",
             "param_key": "session_ema_neutral_penalty", "default": -3},
            {"signal": "observation_bias", "condition": "neutral", "score_change": "+3", "description": "[CTX] Observation neutral confirms range",
             "param_key": "observation_neutral_bonus", "default": 3},
            {"signal": "weekly_trend", "condition": "neutral", "score_change": "+3", "description": "[CTX] Weekly neutral confirms range",
             "param_key": "weekly_trend_bonus", "default": 3},
            {"signal": "regime_stability", "condition": "sell 3+d", "score_change": "+3", "description": "[CTX] Stable sell regime",
             "param_key": "regime_stability_bonus", "default": 3},
            {"signal": "regime_instability", "condition": "4+ changes/30d", "score_change": "-3", "description": "[CTX] Unstable regime",
             "param_key": "regime_instability_penalty", "default": -3},
        ],
    },
    "Short Strangle": {
        "direction": "Neutral",
    ...
    "Bull Put Spread": {
        ...
        "scoring_rules": [
            ...
            {"signal": "vol_regime", "condition": "sell_premium", "score_change": "+10", "description": "[CTX] Vol regime favors selling",
             "param_key": "vol_sell_premium_bonus", "default": 10},
            {"signal": "multi_day_trend", "condition": "bullish", "score_change": "+5", "description": "[CTX] Trend aligns with bullish credit",
             "param_key": "trend_alignment_bonus", "default": 5},
            {"signal": "session_ema", "condition": "bullish", "score_change": "+5", "description": "[CTX] Session EMA confirms BPS",
             "param_key": "session_ema_alignment_bonus", "default": 5},
            {"signal": "session_rsi", "condition": "rising", "score_change": "+3", "description": "[CTX] RSI momentum confirms BPS",
             "param_key": "session_rsi_momentum_bonus", "default": 3},
            {"signal": "session_bb", "condition": "lower", "score_change": "+3", "description": "[CTX] BB lower — mean reversion helps BPS",
             "param_key": "session_bb_reversal_bonus", "default": 3},
            {"signal": "session_vwap", "condition": "> +0.3%", "score_change": "+3", "description": "[CTX] Above VWAP confirms BPS",
             "param_key": "session_vwap_confirmation_bonus", "default": 3},
            {"signal": "observation_bias", "condition": "bullish", "score_change": "+5", "description": "[CTX] Observation confirms BPS",
             "param_key": "observation_bias_bonus", "default": 5},
            {"signal": "weekly_trend", "condition": "bullish", "score_change": "+3", "description": "[CTX] Weekly confirms BPS",
             "param_key": "weekly_trend_bonus", "default": 3},
            {"signal": "consecutive_days", "condition": "3+ down", "score_change": "+3", "description": "[CTX] Overextension helps BPS",
             "param_key": "consecutive_day_bonus", "default": 3},
        ],
    },
    "Bear Call Spread": {
        "direction": "Bearish",
        ...
        "scoring_rules": [
            ...
            {"signal": "vol_regime", "condition": "sell_premium", "score_change": "+10", "description": "[CTX] Vol regime favors selling",
             "param_key": "vol_sell_premium_bonus", "default": 10},
            {"signal": "multi_day_trend", "condition": "bearish", "score_change": "+5", "description": "[CTX] Trend aligns with bearish credit",
             "param_key": "trend_alignment_bonus", "default": 5},
            {"signal": "session_ema", "condition": "bearish", "score_change": "+5", "description": "[CTX] Session EMA confirms BCS",
             "param_key": "session_ema_alignment_bonus", "default": 5},
            {"signal": "session_rsi", "condition": "falling", "score_change": "+3", "description": "[CTX] RSI momentum confirms BCS",
             "param_key": "session_rsi_momentum_bonus", "default": 3},
            {"signal": "session_bb", "condition": "upper", "score_change": "+3", "description": "[CTX] BB upper — mean reversion helps BCS",
             "param_key": "session_bb_reversal_bonus", "default": 3},
            {"signal": "session_vwap", "condition": "< -0.3%", "score_change": "+3", "description": "[CTX] Below VWAP confirms BCS",
             "param_key": "session_vwap_confirmation_bonus", "default": 3},
            {"signal": "observation_bias", "condition": "bearish", "score_change": "+5", "description": "[CTX] Observation confirms BCS",
             "param_key": "observation_bias_bonus", "default": 5},
            {"signal": "weekly_trend", "condition": "bearish", "score_change": "+3", "description": "[CTX] Weekly confirms BCS",
             "param_key": "weekly_trend_bonus", "default": 3},
            {"signal": "consecutive_days", "condition": "3+ up", "score_change": "+3", "description": "[CTX] Overextension helps BCS",
             "param_key": "consecutive_day_bonus", "default": 3},
        ],
    },
    "Bull Call Spread": {
        ...
        "scoring_rules": [
            ...
            {"signal": "vol_regime", "condition": "buy_premium", "score_change": "+10", "description": "[CTX] Vol regime favors buying",
             "param_key": "vol_sell_premium_bonus", "default": 10},
            {"signal": "multi_day_trend", "condition": "bullish", "score_change": "+5", "description": "[CTX] Trend aligns with bullish debit",
             "param_key": "trend_alignment_bonus", "default": 5},
        ],
    },
    "Bear Put Spread": {
        ...
        "scoring_rules": [
            ...
            {"signal": "vol_regime", "condition": "buy_premium", "score_change": "+10", "description": "[CTX] Vol regime favors buying",
             "param_key": "vol_sell_premium_bonus", "default": 10},
            {"signal": "multi_day_trend", "condition": "bearish", "score_change": "+5", "description": "[CTX] Trend aligns with bearish debit",
             "param_key": "trend_alignment_bonus", "default": 5},
        ],
    },
    "Iron Condor": {
